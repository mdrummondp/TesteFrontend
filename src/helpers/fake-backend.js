export function configureFakeBackend(urlLogin) {
    //let users = [{ id: 1, username: 'admin', password: 'admin', firstName: 'Test', lastName: 'User', role: 'Admin' }];
            ...
            setTimeout(() => {
                ...
                if (url.endsWith('/users/authenticate') && opts.method === 'POST') {
                    ...
                    fetch(urlLogin, {
                        ...
                        body:JSON.stringify({ email:params.username,senha:params.password})
                     })
